<template>
	<view class="content" :style="{ width: wrapperBox.width + 'px', height: wrapperBox.height + 'px' }">
		<web-view src="http://www.example.com" style="width: 100%; height: 300rpx;"></web-view>

		<!-- <web-view src="http://baidu.com"
			style="width: 200px; height: 300px; position: absolute; top: 100px; left: 100px;"></web-view> -->
...
export default {
	...
	methods: {
		...
		initOffscreenCanvas() {
			...
			const canvas = uni.createOffscreenCanvas({ type: '2d', width: this.canvasInfo.width, height: this.canvasInfo.height })
