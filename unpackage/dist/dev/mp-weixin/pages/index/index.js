...
var _seatNew = __webpack_require__(/*! ./seatNew.js */ 42);
...
var seatInfoList = _seatNew.seatInfo.datas;
var _default = {
  data: function data() {
    return {
      canvasContainerBox: {
  ...
  methods: {
    ...
    calculateBoundingRectangle: function calculateBoundingRectangle() {
      ...
      var maxX = -Infinity;
      var maxY = -Infinity;
      var data = _seatNew.seatInfo.datas;
    ...
    drawCircle: function drawCircle(payload) {
      ...
      if (isFill) {
        var curColor = angle && angle.picture ? '#CF3B34' : '#C8C8C8';
